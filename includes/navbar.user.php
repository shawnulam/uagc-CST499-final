	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse flex-grow-1 text-right" id="defNavbar">
			<ul class="navbar-nav ms-auto flex-nowrap">
				...
				<li class="nav-item">
					<a href="index.php?page=addcourse" class="nav-link m-2 menu-item nav-active">Add Course</a>
				</li>
				<li class="nav-item">
					<a href="index.php?page=schedule" class="nav-link m-2 menu-item nav-active">View Schedule</a>
				</li>
				<li class="nav-item">
