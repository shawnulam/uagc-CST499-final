	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse flex-grow-1 text-right" id="defNavbar">
			<ul class="navbar-nav ms-auto flex-nowrap">
				...
				<li class="nav-item">
					<a href="index.php?page=login" class="nav-link m-2 menu-item nav-active">Login</a>
				</li>
				<li class="nav-item">
					<a href="index.php?page=registration" class="nav-link m-2 menu-item nav-active">Registration</a>
				</li>
				<li class="nav-item">
